...
class TestCourierDelete:
    ...
    def test_courier_delete_without_id(self):
        ...
        assert response.status_code == 400 and response_text == ResponseText.text_courier_delete_insufficient_data
    ...
    def test_courier_delete_incorrect_id(self):
        ...
        response_text = response.json()["message"]
        assert response.status_code == 404 and response_text == ResponseText.text_courier_delete_not_found
